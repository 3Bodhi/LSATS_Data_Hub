...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/mcommunity_group_ingestion.log"),
...
class MCommunityGroupIngestionService:
    ...
    def __init__(self, database_url: str, ldap_config: Dict[str, Any]):
        ...
        logger.info(
            "MCommunity group ingestion service initialized with content hashing"
        )
    ...
    def _normalize_ldap_attribute(self, value: Any) -> Any:
        ...
        group attributes like member, groupMember, owner, cn can be either strings
