...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/umich_employee_ingestion.log"),
...
class UMichEmployeeIngestionService:
    ...
    def __init__(
        ...
        logger.info("UMich employee ingestion service initialized with content hashing")
    ...
    def ingest_umich_employees_with_change_detection(self) -> Dict[str, Any]:
        ...
        run_id = self.create_ingestion_run("umich_api", "employee")
...
def main():
    ...
    try:
        ...
        print("✅ University of Michigan employee ingestion completed successfully!")
