...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/ad_ou_ingestion.log"),
...
class ActiveDirectoryOUIngestionService:
    ...
    def ingest_ad_ous_with_change_detection(self) -> Dict[str, Any]:
        ...
        This method:
        1. Fetches all OU data from configured Active Directory search bases
        ...
        run_id = self.create_ingestion_run("active_directory", "organizational_unit")
        ...
        try:
            ...
            # Step 1: Get existing OU content hashes from bronze layer
            existing_hashes = self._get_existing_ou_hashes()

            # Step 2: Fetch current data from Active Directory LDAP (all search bases)
            all_ous = []
